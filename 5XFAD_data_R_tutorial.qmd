...
#The individual metadata file was recently updated and has some errors and changed some column headings. While we sort this out, I am going to upload an older version (version 3):
ind_meta_object <- synGet(entity = 'syn22103212', version=3)
ind_meta <- read.csv(ind_meta_object$path)
...
```{r gene-name-conversion-functions, eval=FALSE, include=FALSE}
