---
title: "AD Knowledge Portal: Upload and explore 5XFAD mouse data in Rstudio"
output: html_notebook
---


Upload the normalized counts matrix for 5XFAD mice and related metadata
```{r}
#counts matrix
p <- synapser::synGet('syn22108848')
counts <- read.delim(p$path)

#individual metadata
p1 <- synapser::synGet('syn22103212')
ind_meta <- read.csv(p1$path, sep=",")

#biospecimen metadata
p2 <- synapser::synGet('syn22103213')
bio_meta <- read.csv(p2$path, sep=",")
