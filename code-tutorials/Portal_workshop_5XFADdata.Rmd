...
#### **Exercise 1:** **Use [Explore Data](https://adknowledgeportal.synapse.org/Explore/Data) to search for processed RNAseq data from the `Jax.IU.Pitt_5XFAD` mouse study.**
...
# counts matrix
counts <- read_tsv("files/htseqcounts_5XFAD.txt")
