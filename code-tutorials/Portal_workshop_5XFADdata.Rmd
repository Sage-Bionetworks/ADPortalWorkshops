...
#### **Exercise 1:** **Use [Explore Data](https://adknowledgeportal.synapse.org/Explore/Data) to search for `processedRNAseq` data from the `Jax.IU.Pitt_5XFAD` mouse study.**

Then, if we click on the link for the `htseqcounts_5XFAD.txt` file in the AD Portal...
...
query <- synTableQuery("SELECT * FROM syn11346063.17 WHERE ( ( `study` HAS ( 'Jax.IU.Pitt_5XFAD' ) ) AND ( `resourceType` = 'metadata' ) )")
...
```{r bulk-download-synIDs-with-purrr}
